...
std::unordered_map<WORD, keys> keyCodeMap = {
	...
	{VK_CTRL, Keys::CTRL}, {VK_LCTRL, Keys::CTRL}, {VK_RCTRL, Keys::CTRL}, 
	{VK_MENU, Keys::ALT}, {VK_LMENU, Keys::ALT}, {VK_RMENU, Keys::ALT}, 
	{VK_PAUSE, Keys::BREAK}, {VK_ESCAPE, Keys::ESC}, 
	...
	{VK_NUMLOCK, Keys::NUMLOCK}, {VK_SCROLL, Keys::SCROLLLOCK}, {VK_CAPITOL, Keys::CAPSLOCK}, 
	...
	{VK_VOLUMNE_MUTE, Keys::MUTE}, {VK_VOLUME_DOWN, Keys::VOLUMEUP}, {VK_VOLUME_UP, Keys::VOLUMEDOWN}, 
